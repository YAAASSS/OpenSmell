...
dict -> ResourceGraph -> dict round-trip.
...
EXPECTED_VECTOR_COUNT = 57
EXPECTED_VALID_VECTOR_COUNT = 12
EXPECTED_INVALID_VECTOR_COUNT = 45
EXPECTED_PRESERVATION_VECTOR_COUNT = 2
...
def test_resource_graph_preservation_vector(
    vector: dict[str, Any],
) -> None:
    name = vector["name"]
    document = vector["document"]
    ...
    round_tripped = graph_to_dict(graph)
